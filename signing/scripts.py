...
# ***** END LICENSE BLOCK *****
import sys
from signing.utils import check_keys as _check_keys
from signing.certify import run as keycert

def check_keys():
    if len(sys.argv) != 2:
        raise ValueError("Usage:  %s <path to signing INI file>" % sys.argv[0])
